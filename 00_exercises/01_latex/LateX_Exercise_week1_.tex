...
\hypersetup{
pdftitle={Lecture Week 1 Exercise},
pdfauthor={Jaouhari, B. El (Badr)},
pdfsubject={Markup Languages},
pdfkeywords={LaTeX},
...
\title{Lecture Week 1 Exercise}
\author{Jaouhari, B. El (Badr)}
%\date{\today}
\date{}
...
\centering
\begin{tabular}{cc}
\includegraphics[width=0.4\textwidth]{historgam.pdf} &
\includegraphics[width=0.4\textwidth]{Density.pdf} \\

(a) Histogram & (b) Densityplot \\[0.5cm]

\includegraphics[width=0.4\textwidth]{Strip.pdf} &
\includegraphics[width=0.4\textwidth]{Boxplot.pdf} \\

(c) Stripplot & (d) Boxplot \\
\end{tabular}
